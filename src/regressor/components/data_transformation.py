...
import pandas as pd
from regressor.entity.config_entity import DataTransformationConfig
...
# TARGET
### PRE
class TargetColumnTransformer(BaseEstimator, TransformerMixin):
    def __init__(self) -> None:
        super().__init__()
    ...
    def fit(self, X, y=None):
        ...
        self.column_transformer = ColumnTransformer(
            transformers=[
                ...
                ("target", TargetColumnTransformer(), [self.target_col]),
            ]
        )
